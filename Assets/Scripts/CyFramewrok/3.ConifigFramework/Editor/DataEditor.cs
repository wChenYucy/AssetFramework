...
{
    public static string XmlPath = CyFrameworkConfigManager.GetRealFram().m_XmlPath +"/";
    public static string BinaryPath = CyFrameworkConfigManager.GetRealFram().m_BinaryPath + "/";
    ...
    {
        string path = Application.dataPath + XmlPath.Replace("Assets", "");
    ...
    private static void XmlToBinary(string name)
    {
        ...
        try
        {
            ...
            if (type != null)
            {
                ...
                SerializeUtils.BinarySerialize(binaryPath, obj);
